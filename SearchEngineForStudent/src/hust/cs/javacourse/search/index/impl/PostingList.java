...
public class PostingList extends AbstractPostingList {
     ...
     */
    @Override
    public AbstractPosting get(int index){return this.list.get(index);}
     ...
     */
    @Override
    public int indexOf(AbstractPosting posting){return this.list.indexOf(posting);}
     ...
     */
    @Override
    public boolean contains(AbstractPosting posting){return this.list.contains(posting);}
     ...
     */
    @Override
    public void remove(int index){ this.list.remove(index);}
     ...
     */
    @Override
    public void remove(AbstractPosting posting){ this.list.remove(posting);}
     ...
     */
    @Override
    public void sort(){Collections.sort(this.list);}
